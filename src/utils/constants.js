...
export const accordionList =[
    {
        id:1,
        heading:'What is Flexify?',
        details:"Flexify is a streaming service that offers a wide variety of award-winning TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices.You can watch as much as you want, whenever you want – all for one low monthly price. There's always something new to discover and new TV shows and movies are added every week!"
    },
    {
        id:2,
        heading:'How much does Flexify cost?',
        details:"Watch Flexify on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from $6.99 to $19.99 a month. No extra costs, no contracts"
    },
    {
        id:3,
    ...
    },
    {
        ...
        details:"Watch anywhere, anytime. Sign in with your Flexify account to watch instantly on the web at Flexify.com from your personal computer or on any internet-connected device that offers the Flexify app, including smart TVs, smartphones, tablets, streaming media players and game consoles.You can also download your favorite shows with the iOS, Android, or Windows 10 app. Use downloads to watch while you're on the go and without an internet connection. Take Flexify with you anywhere."
    },
    {
        id:5,
        heading:'How do I cancel?',
        details:"Flexify is flexible. There are no pesky contracts and no commitments. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime."
    },
    {
        id:6,
        heading:'What can I watch on Flexify?',
        details:"Flexify has an extensive library of feature films, documentaries, TV shows, anime, award-winning Flexify originals, and more. Watch as much as you want, anytime you want."
    },
    {
        id:7,
        heading:'Is Flexify good for kids?',
        details:"The Flexify Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and movies in their own space.Kids profiles come with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch and block specific titles you don’t want kids to see."
    }
];
...
export const columnsOfFooter = [
    ...
    {
        id:2,
        links: ['Help Center', 'Jobs', 'Ways to Watch', 'Corporate Information', 'Only on Flexify'],
    },
    {
        id:3,
        links: ['Account', 'Flexify Shop', 'Terms of Use', 'Contact Us', 'Do Not Sell or Share My Personal Information'],
    },
    {
        id:4,
